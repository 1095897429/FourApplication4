package com.ngbj.browser4.network.retrofit.helper;


import com.ngbj.browser4.bean.AdBean;
import com.ngbj.browser4.bean.AdObjectBean;
import com.ngbj.browser4.bean.BuildingBean;
...
import com.ngbj.browser4.network.retrofit.api.AppService;
import com.ngbj.browser4.network.retrofit.response.HttpResponse;
import com.ngbj.browser4.network.retrofit.utils.RetrofitUtil;
...
//    }
    ...
    public Flowable<HttpResponse<List<AdBean>>> getRandHotSearchData(){
        return mAppService.getRandHotSearchData();
    }
