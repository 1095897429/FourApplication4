...
import com.ngbj.browser4.adpter.DownFileAdapter;
import com.ngbj.browser4.adpter.HomeFragmentAdapter;
import com.ngbj.browser4.adpter.IndexGridViewAdapter;
import com.ngbj.browser4.adpter.IndexViewPagerAdapter;
import com.ngbj.browser4.adpter.Index_Cool_Adapter;
import com.ngbj.browser4.adpter.Index_HotSearch_Adapter;
import com.ngbj.browser4.adpter.NewsMultiAdapter;
import com.ngbj.browser4.bean.AdBean;
import com.ngbj.browser4.bean.AdObjectBean;
import com.ngbj.browser4.bean.BookMarkData;
import com.ngbj.browser4.bean.CountData;
import com.ngbj.browser4.bean.HistoryData;
import com.ngbj.browser4.bean.NewsBean;
import com.ngbj.browser4.bean.NewsSaveMultiBean;
import com.ngbj.browser4.bean.PicBean;
import com.ngbj.browser4.bean.StatisticsBean;
import com.ngbj.browser4.bean.WeatherBean;
import com.ngbj.browser4.bean.WeatherSaveBean;
import com.ngbj.browser4.constant.ApiConstants;
import com.ngbj.browser4.db.DBManager;
import com.ngbj.browser4.event.CollectEvent;
import com.ngbj.browser4.event.DataToTopEvent;
import com.ngbj.browser4.event.History_CollectionEvent;
import com.ngbj.browser4.event.NewsShowFragmentEvent;
import com.ngbj.browser4.event.RefreshDataEvent;
import com.ngbj.browser4.event.RefreshDataSecondEvent;
import com.ngbj.browser4.event.TypeEvent;
import com.ngbj.browser4.network.retrofit.helper.RetrofitHelper;
import com.ngbj.browser4.network.retrofit.response.BaseListSubscriber;
import com.ngbj.browser4.network.retrofit.response.BaseObjectSubscriber;
import com.ngbj.browser4.network.retrofit.utils.Sha1SignUtils;
import com.ngbj.browser4.util.AppUtil;
import com.ngbj.browser4.util.DeviceIdHepler;
import com.ngbj.browser4.util.SPHelper;
import com.ngbj.browser4.util.StringUtils;
import com.ngbj.browser4.util.ToastUtil;
import com.ngbj.browser4.view.CustomDecoration;
import com.ngbj.browser4.view.StickyNavLayout2;
...
//                                KLog.d("温度：" + weatherBean.getHeWeather6().get(0).getNow().getTmp());
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        headerView = getLayoutInflater().inflate(R.layout.head1, null);
        mViewPagerGridView = headerView.findViewById(R.id.viewPager_gridView);
        changeHotSearch =  headerView.findViewById(R.id.changeHotSearch);
        moreNews =  headerView.findViewById(R.id.moreNews);
        cool_recycleView = headerView.findViewById(R.id.cool_recycleView);
    }
...
//            MobclickAgent.onEvent(getActivity(), "ad4");//参数二为当前统计的事件ID
    ...
    protected void initData() {
        ...
        myRecyclerAdapter.addHeaderView(headerView);
    ...
    private void initEvent() {
        ...
        myRecyclerAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                isNetwork = (boolean) SPHelper.get(getActivity(),"is_network",false);
                if(isNetwork){
                    int myType = getParentFragmentToType(Index_Fragment.this);
    ...
    private void initRecycleView2() {
        ...
        //设置布局管理器
        newsRecycleView.setLayoutManager(layoutManager2);
        //设置为垂直布局，这也是默认的
        layoutManager2.setOrientation(OrientationHelper. VERTICAL);
        //设置Adapter
        myRecyclerAdapter = new NewsMultiAdapter(mList);
        newsRecycleView.setAdapter(myRecyclerAdapter);
        //下划线
        newsRecycleView.addItemDecoration(new CustomDecoration(getActivity(),
        ...
        newsRecycleView.setFocusable(false);
...
//                url = ApiConstants.BAIDUURL + "s?wd=" + url;//URL是根据使用百度搜索某个关键字得到的url截取得到的
    ...
    private void setSetting() {
        ...
        String dir = getActivity().getApplicationContext().getDir("database4",Context.MODE_PRIVATE).getPath();
